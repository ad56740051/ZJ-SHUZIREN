...
parser.add_argument(
    "--asr_model",
    type=str,
    default=r"funasr\iic\speech_paraformer-large_asr_nat-zh-cn-16k-common-vocab8404-pytorch",
    #help="model from modelscope",
)
parser.add_argument("--asr_model_revision", type=str, help="")
parser.add_argument(
    "--asr_model_online",
    type=str,
    default=r"funasr\iic\speech_paraformer-large_asr_nat-zh-cn-16k-common-vocab8404-online",
    #help="model from modelscope",
)
parser.add_argument("--asr_model_online_revision", type=str, help="")
parser.add_argument(
    "--vad_model",
    type=str,
    default=r"funasr\iic\speech_fsmn_vad_zh-cn-16k-common-pytorch",
    #help="model from modelscope",
)
parser.add_argument("--vad_model_revision", type=str, help="")
parser.add_argument(
    "--punc_model",
    type=str,
    default=r"funasr\iic\punc_ct-transformer_zh-cn-common-vad_realtime-vocab272727",
    #help="model from modelscope",
)
parser.add_argument("--punc_model_revision", type=str, help="")
